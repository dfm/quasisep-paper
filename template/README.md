...
LaTeX template based on the Data Analysis Recipes series

![](thumbnail.png)

- Author: Dan Foreman-Mackey (N/A)
- Author Website: https://github.com/dfm/dar-myst-template
- [Submission Guidelines](https://github.com/dfm/dar-myst-template)
